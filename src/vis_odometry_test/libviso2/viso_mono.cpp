...
VisualOdometryMono::VisualOdometryMono(parameters param) : param(param),
...
void VisualOdometryMono::fundamentalMatrix(const vector<Matcher::p_match> &p_matched, const vector<int32_t> &active,
                                           Matrix &F) {
...
void
VisualOdometryMono::EtoRt(Matrix &E, Matrix &K, vector<Matcher::p_match> &p_matched, Matrix &X, Matrix &R, Matrix &t) {
...
int32_t VisualOdometryMono::triangulateChieral(vector<Matcher::p_match> &p_matched, Matrix &K, Matrix &R, Matrix &t,
                                               Matrix &X) {
